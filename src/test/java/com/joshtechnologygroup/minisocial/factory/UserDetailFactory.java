...
public class UserDetailFactory {
    ...
    public static UserDetail defaultUserDetail() {
        return defaultUserDetail((long) FAKER.number().positive());
    }

    public static UserDetail defaultUserDetail(Long userId) {
        UserDetail userDetail = new UserDetail();
        userDetail.setUserId(userId);
        userDetail.setFirstName(FAKER.name().firstName());
        userDetail.setLastName(FAKER.name().lastName());
        userDetail.setAge(FAKER.number().numberBetween(18, 90));
        userDetail.setGender(FAKER.options().option(Gender.class));
        userDetail.setMaritalStatus(
            FAKER.options().option(MaritalStatus.class)
        );
        return userDetail;
    }
    ...
    public static UserDetailCreateRequest.UserDetailCreateRequestBuilder defaultUserDetailCreateRequest(
        ...
        return UserDetailCreateRequest.builder()
            ...
            .residentialDetails(
                ResidentialDetailFactory.defaultResidentialDetailCreateRequest().build()
            )
            .officialDetails(
                OfficialDetailFactory.defaultOfficialDetailCreateRequest().build()
            );
    }
    ...
    public static UserDetailDTO.UserDetailDTOBuilder defaultUserDetailDTO(
        ...
        return UserDetailDTO.builder()
            ...
            .maritalStatus(userDetail.getMaritalStatus())
            .residentialDetails(
                ResidentialDetailFactory.defaultResidentialDetailDTO(
                    userDetail.getUserId()
                ).build()
            )
            .officialDetails(
                OfficialDetailFactory.defaultOfficialDetailDTO(
                    userDetail.getUserId()
                ).build()
            );
    }

    public static UserDetailUpdateRequest.UserDetailUpdateRequestBuilder defaultUserDetailUpdateRequest(
        Long userId
    ) {
        UserDetail userDetail = defaultUserDetail();
        userDetail.setUserId(userId);
        return defaultUserDetailUpdateRequest(userDetail);
    }

    public static UserDetailUpdateRequest.UserDetailUpdateRequestBuilder defaultUserDetailUpdateRequest(
        UserDetail userDetail
    ) {
        return UserDetailUpdateRequest.builder()
            .firstName(userDetail.getFirstName())
            .lastName(userDetail.getLastName())
            .age(userDetail.getAge())
            .gender(userDetail.getGender())
            ...
            .officialDetails(
                OfficialDetailFactory.defaultOfficialDetailUpdateRequest(
                    userDetail.getUserId()
                ).build()
            );
    }
