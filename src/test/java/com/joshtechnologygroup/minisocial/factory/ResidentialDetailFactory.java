...
public class ResidentialDetailFactory {
    ...
    public static ResidentialDetail defaultResidentialDetail() {
        return defaultResidentialDetail((long) FAKER.number().positive());
    }
    ...
    public static ResidentialDetail defaultResidentialDetail(Long userId) {
        ...
        residentialDetail.setAddress(FAKER.address().fullAddress());
        residentialDetail.setCity(FAKER.address().city());
        residentialDetail.setState(FAKER.address().state());
        residentialDetail.setCountry(FAKER.address().country());
